    ...
    <div className={styles.page}>
      ...
      <div className={styles.Programm}>
          ...
          {events.map((event, index) => (
            <div key={index} style={{ marginBottom: '30px' }}>
              <div className={styles.eventList}>
                <button className={styles.buttonDeleteEvent} onClick={() => deleteEvent(index)}>×</button>
        ...
        <div className={styles.contentAddEvent}>
            <label>*</label>
            <input className={styles.inputEvent}
                type="text"
                name="time"
                value={newEvent.time}
                onChange={inputEvent}
            ...
            <div style={{ position: 'relative' }}>
                <input className={styles.inputColorEvent}
                    type="color"
                    name="color"
                    value={newEvent.color}
                    onChange={inputEvent}
                    required/>
                <button className={styles.customButton} style={{ backgroundColor: newEvent.color}}>Цвет пункта</button>
            </div>
            <button className={styles.buttonAddEvent} onClick={addEvent}>Добавить новое событие</button>
        </div>
        <hr className={styles.border}/>       
      </div>
